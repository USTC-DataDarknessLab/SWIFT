...
parser.add_argument('--txt', type=str, help='txt file path', default = "/root/swift/dataset/BITCOIN/soc-bitcoin.edges")
...
print('save csv...')
df.to_csv('/root/swift/dataset/{}/edges.csv'.format(args.data))

print('generate graph...')
#gen_graph
df = pd.read_csv('/root/swift/dataset/{}/edges.csv'.format(args.data))
...
np.savez('/root/swift/dataset/{}/ext_full.npz'.format(args.data), indptr=ext_full_indptr, indices=ext_full_indices, ts=ext_full_ts, eid=ext_full_eid)